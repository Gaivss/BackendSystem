				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<!--工具栏-->
							<form method="post" action="${pageContext.request.contextPath}/product/updateProduct.do">
								<div class="pull-left">
									<div class="form-group form-inline">
										<div class="btn-group">
											...
											<button formmethod="post"  id="deleteProduct" type="button" class="btn btn-default" title="删除" >
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												<button href="${pageContext.request.contextPath}/product/delete?id=${product.id}"
														type="button" class="btn bg-olive btn-xs">删除</button>
												<button href="${pageContext.request.contextPath}/product/update?id=${product.id}"
														type="button" class="btn bg-olive btn-xs">更新</button>
												<button href="${pageContext.request.contextPath}/product/on?id=${product.id}"
														type="button" class="btn bg-olive btn-xs">开启</button>
												<button href="${pageContext.request.contextPath}/product/off?id=${product.id}"
														type="button" class="btn bg-olive btn-xs">屏蔽</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
